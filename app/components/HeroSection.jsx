...
const HeroSection = () => {
  ...
  return (
      <section id='home' className='min-h-screen  z-50'>
        <Container >
           <Spotlight />
           <div className='flex justify-between mt-20 lg:px-48'>
            <div className='flex  justify-center flex-col gap-3  pr-20'>
              ...
              <div className='flex gap-3 mt-3'>
                <motion.a href='#projects' ref={ref} initial='hidden' animate={controls} variants={itemVariants} className='text-sm cursor-pointer font-semibold bg-sky-500 border text-neutral-200 border-sky-500 rounded-lg py-2 px-3'>Explore projects</motion.a>
                <motion.button ref={ref} initial='hidden' animate={controls} variants={itemVariants} className='text-sm font-semibold border px-3 py-2 rounded-lg border-sky-500 text-sky-500'>Download CV</motion.button>
              </div>
            </div>
