           ...
           <div className='flex  justify-between mt-20 lg:px-10 xl:px-48'>
            ...
            border={true}
             ...
             <Image className='absolute  h-[600px] bottom-0    object-cover w-[450px] ' src={img} alt="profile_img" />
              ...
              <TextGenerateEffect className={'font-mono'}  textClass={'text-xs  sm:text-sm sm:font-thin z-30 relative  text-gray-300 sm:!text-neutral-300'} words={`A passionate Full-Stack Web Developer with real-world experience in E-commerce ( ikonmart.com ) and production-level POS systems training. Skilled in modern Javascript frameworks, PHP-Laravel and Docker, along with UI libraries such as Bootstrap and Tailwind CSS. Experienced with Framer Motion, NextUI, Aceternity UI, Nuxt UI, PrimeVue, and more. A quick learner, highly adaptable, and thrives in collaborative environments.`}/>
